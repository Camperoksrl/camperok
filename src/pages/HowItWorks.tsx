...
const steps = [
  {
    ...
    description:
      "Esplora la nostra flotta e trova il veicolo perfetto per le tue esigenze. Filtra per tipo, capacità e budget.",
  },
  {
    icon: CalendarCheck,
    number: "02",
    ...
    description:
      "Seleziona le date di ritiro e riconsegna. Riceverai una conferma entro 24 ore con tutti i dettagli.",
  },
  {
    icon: Key,
    number: "03",
    ...
    description:
      "Vieni a ritirare il camper presso il rimessaggio in zona Ardeatina, a Roma. Ti forniremo un briefing completo sul veicolo.",
  },
  {
    icon: Compass,
    number: "04",
    ...
    description:
      "Goditi il viaggio! Con assistenza e assicurazione completi, puoi concentrarti solo sul divertimento.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sì, tutti i nostri noleggi includono assicurazione RCA, kasko con franchigia e assistenza stradale 24/7.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sì, puoi viaggiare in tutti i paesi dell'Unione Europea. Per viaggi extra-UE, contattaci in anticipo per verificare la copertura assicurativa.",
  },
  {
    question: "Come funziona la riconsegna?",
    answer:
      "Il veicolo deve essere riconsegnato con il serbatoio pieno e pulito internamente. La riconsegna avviene presso la stessa sede di ritiro.",
  },
  {
    question: "Cosa succede in caso di guasto?",
    answer:
      "Hai a disposizione l'assistenza fornita dalle nostre compagnie assicurative, attiva 24/7.",
  },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {steps.map((step) => (
                <div key={step.number} className="relative space-y-4">
                  <span className="text-6xl font-bold text-primary/10 text-display">
                    {step.number}
                  </span>
